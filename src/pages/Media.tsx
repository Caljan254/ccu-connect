...
const mediaCategories = [
  {
    ...
    subcategories: [],
    items: [
      { name: "Party Logo (PNG)", type: "image", category: "branding", subcategory: "logos", fileName: "ccu-logo.png" },
      { name: "Party Flag (PNG)", type: "image", category: "branding", subcategory: "Flag", fileName: "ccu-flag.png" },
      { name: "CCU Logo Landscape", type: "image", category: "branding", subcategory: "landscape", fileName: "logo-landscape.png" },
      { name: "Brand Guide", type: "image", category: "branding", subcategory: "brand-guidelines", fileName: "brand-guide.png" },
    ],
  },
  {
    id: "documents",
    ...
    items: [
      ...
      { name: "Financial Report 2024", type: "pdf", category: "documents", subcategory: "financial-reports", fileName: "financial-report-2024.pdf" },
      { name: "Manifesto", type: "pdf", category: "documents", subcategory: "constitution", fileName: "ccu-manifesto.pdf" },
      { name: "Membership Form", type: "pdf", category: "documents", subcategory: "forms", fileName: "membership-form.pdf" },
      { name: "Strategic Plan", type: "pdf", category: "documents", subcategory: "constitution", fileName: "strategic-plan.pdf" },
      { name: "Code of Conduct", type: "pdf", category: "documents", subcategory: "constitution", fileName: "electoral-code-of-conduct.pdf" },
      { name: "Disciplinary Guidelines", type: "pdf", category: "documents", subcategory: "constitution", fileName: "disciplinary-guidelines.pdf" },
      { name: "Pledge of Commitment", type: "pdf", category: "documents", subcategory: "constitution", fileName: "pledge-of-commitment.pdf" },
    ],
  },
  {
    id: "photos",
    ...
    subcategories: [],
    items: [
      { name: "Website Banner", type: "image", category: "photos", subcategory: "campaign-materials", fileName: "ccu-website-banner.png" },
      { name: "Facebook Cover 2025", type: "image", category: "photos", subcategory: "social-media", fileName: "facebook-cover-2025.png" },
    ],
  },
  {
    id: "videos",
    ...
    subcategories: [],
    items: [
      { name: "Website Banners Video", type: "video", category: "videos", subcategory: "videos", fileName: "ccu-website-banners.mp4" },
    ],
  },
];
