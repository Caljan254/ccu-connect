      ...
      <Layout>
        ...
        <section className="container-section">
          ...
          <div className="mt-12 bg-muted rounded-2xl p-8">
            <h3 className="font-display text-xl font-bold mb-4">Download Instructions</h3>
            <ul className="space-y-2 text-muted-foreground">
              <li>• Click the download button to save files to your device</li>
              ...
              <li>• Page will refresh automatically after download completes</li>
            </ul>
          </div>
        </section>
      </Layout>
